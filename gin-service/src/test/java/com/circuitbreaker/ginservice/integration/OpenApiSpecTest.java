...
@DisplayName("OpenAPI Spec Tests - gin-service")
class OpenApiSpecTest {
    ...
    void apiDocs_ShouldReturnValidJson() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.info.title").value("GIN Service API"))
    ...
    void apiDocs_ShouldContainExpectedEndpoints() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/time'].post").exists());
    }
    ...
    void apiDocs_ShouldContainSchemaDefinitions() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.components.schemas.TimeRequest").exists())
                .andExpect(jsonPath("$.components.schemas.AckResponse").exists());
    }
}
